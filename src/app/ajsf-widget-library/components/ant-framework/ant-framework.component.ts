...
@Component({
  selector: 'app-ant-framework',
  templateUrl: './ant-framework.component.html',
  styleUrls: ['./ant-framework.component.scss'],
})
export class AntFrameworkComponent implements OnInit, OnChanges {
